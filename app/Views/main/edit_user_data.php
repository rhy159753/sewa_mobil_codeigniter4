                                        ...
                                        <?php foreach ($user as $data) { ?>
                                            <table class="table table-bordered" id="dataTable" cellspacing="0">
                                                <tr>
                                                    <td>Nama User</td>
                                                    <td>
                                                        <input type="hidden" value="<?= $data->user_id ?>" name="user_id" id="user_id" required="true" class="form-control">
                                                        <input type="text" value="<?= $data->user_name ?>" name="user_name" id="user_name" required="true" class="form-control">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Email</td>
                                                    <td>
                                                        <input type="email" value="<?= $data->user_email ?>" name="user_email" id="user_email" required="true" class="form-control">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Level</td>
