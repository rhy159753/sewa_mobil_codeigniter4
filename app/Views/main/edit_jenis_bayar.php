        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Jenis Pembayaran > Edit</h1>
                    <hr>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card shadow">
                                <div class="card-body">
                                    <form action="<?=base_url('jenis_bayar/edit')?>" method="POST">
                                            ...
                                            <table class="table table-bordered" id="dataTable" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="text" value="<?= $data->jenis_bayar ?>" name="jenis_bayar" id="jenis_bayar" required="true" class="form-control">
                                                    </td>
                                                </tr>
                                            </table>
                                        <?php } ?>
