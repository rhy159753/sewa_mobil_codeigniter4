        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Jenis Pembayaran > Tambah</h1>
                    <hr>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card shadow">
                                <div class="card-body">
                                    <form action="<?=base_url('jenis_bayar/add')?>" method="POST">
                                            <table class="table table-bordered" id="dataTable" cellspacing="0">
                                                <tr>
                                                    <td>Jenis Pembayaran</td>
                                                    <td>
                                                        <input type="text" name="jenis_bayar" id="jenis_bayar" required="true" class="form-control">
                                                    </td>
                                                </tr>
                                            </table>
                                        <div class="row">
