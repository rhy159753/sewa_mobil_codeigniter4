        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Data Mobil > Booking Mobil</h1>
                    <hr>
                    <div class="row">
                        <div class="col-sm-12">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <input type="date" name="tgl_pinjam" id="tgl_pinjam" required="required" autocomplete="off" class="form-control text-right">
                                                            </div>
                                                            <div class="col-md-2 text-center mt-2">
                                                                -
                                                            </div>
                                                            <div class="col-md-5">
                                                                <input type="date" name="tgl_kembali" id="tgl_kembali" required="required" autocomplete="off" class="form-control text-right">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" name="total_str" id="total_str" required="required" autocomplete="off" disabled class="form-control text-right">
                                                                <input type="hidden" name="total" id="total" required="required" autocomplete="off" class="form-control text-right">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <select name="jebar" id="jebar" class="form-control">
                                                                    ...
                                                                    <?php foreach ($jenis_bayar as $data) : ?>
                                                                        <option value="<?= $data->id ?>"><?= $data->jenis_bayar ?></option>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                        ...
                                        *Pembayaran harus lunas sebelum masuk awal rentang tanggal book. Baik secara <b>Cash</b>, maupun secara <b>Kredit</b>.
                                        <div class="row mt-5">
                                            <div class="col-md-12 text-right">
                                                <a href="<?= base_url('mobil') ?>" class="btn btn-info">Kembali</a>
            ...
            $.ajax({
                ...
                success: function(res) {
                    if(res.message == 'success') {
                        $('#notif').addClass('alert-success').fadeIn().html('Sukses Membuat Pesanan. Tunggu Sebentar!');
                        setTimeout(function() {
                            window.location.href = "<?= base_url('riwayat_pesanan') ?>/detail/"+res.data;
                        },2000);
                    } else {
